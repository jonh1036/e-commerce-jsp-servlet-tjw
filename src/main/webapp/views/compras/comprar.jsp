                    ...
                    <div class="col-md-12">
                        ...
                        <form action="comprar" method="post">
                            ...
                            <div class="form-group">
                                <input class="form-control" type="text" required="required" name="nomeComprador" placeholder="Digite o seu nome" autofocus/>
                            </div>
                            <div class="form-group">
                                <input class="form-control" type="text" required="required" maxlength="16" name="cartaoComprador" placeholder="Digite o seu cartão de crédito"/>                        
                            </div>
                            <div class="form-group">
                                <input class="form-control" type="text" required="required" maxlength="3" name="codSegurancaComprador" placeholder="Digite o código de segurança"/>                        
                            </div>
